...
<div class="shell">
  ...
  <header class="header">
    <div class="brand">
      ...
      <div>
        ...
        <div class="brand-sub">ROTATION RESCAN · v2</div>
      </div>
    </div>
  ...
  <div class="desc">
    ...
    <span><strong>Start</strong> scans the five cards as references, then the robot turns 180°, waits 15s for a human to flip one card, turns back, and rescans to flag the rotated card.</span>
    <span class="rule">v2 — odom closed-loop 180° turns; the check scan is cross-matched against the references and each card is compared in normal vs 180° orientation.</span>
  </div>
  ...
  <section class="command">
    ...
    <div class="panel">
      ...
      <span id="status" style="display:none;">READY — Click Start to detect cards</span>
    </div>
    ...
    <div class="panel">
      ...
      <div class="field">
        <div class="field-label">Check Slots</div>
    ...
    <div class="panel">
      ...
      <ol class="phase-list" id="phase-list">
        ...
        <li class="phase" data-phase="away">
          <span class="phase-dot"></span>
          <span class="phase-text">Mask</span>
        </li>
        <li class="phase" data-phase="wait">
          <span class="phase-dot"></span>
          <span class="phase-text">Contours</span>
        </li>
        <li class="phase" data-phase="return">
          <span class="phase-dot"></span>
          <span class="phase-text">Crops</span>
        </li>
      ...
      <div class="phase-result" id="phase-result">
        ...
        <span class="phase-result-value empty" id="result">0/5 detected</span>
      </div>
  ...
  <div class="section-head">
    ...
    <span class="section-meta">RGB + masked card detail</span>
  </div>
  ...
  <div class="section-head">
    ...
    <div class="section-line"></div>
    <span class="section-meta" id="slot-count">0 / 5 detected</span>
  </div>
...
(function () {
  ...
  function updateSlotCount() {
    ...
    setText('slot-count', `${count} / 5 detected`);
  }
  ...
  async function refreshStatus() {
    try {
      ...
      setText('result', data.result || '0/5 detected');
      ...
      const result = $('result');
      if (result) {
        const empty = !data.result || data.result === '0/5 detected';
      ...
      if (running) {
        ...
        setState('Failed', 'run-state-stopped');
        stopClock();
      } else {
        setState('Idle');
